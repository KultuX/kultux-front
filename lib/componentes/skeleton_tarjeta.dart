...
class SkeletonTarjetaBusqueda extends StatefulWidget {
  const SkeletonTarjetaBusqueda({super.key});

  @override
  State<SkeletonTarjetaBusqueda> createState() => _SkeletonState();
}

class _SkeletonState extends State<SkeletonTarjetaBusqueda>
