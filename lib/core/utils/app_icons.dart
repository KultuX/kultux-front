class AppIcons {
  static const Map<String, String> accommodationIcons = {
  ...
  static const Map<String, String> restaurantIcons = {
  ...
  static String getAccommodationIcon(String categoria) {
    return accommodationIcons[categoria] ?? 'assets/iconos/hotel.svg';
  }

  static String getRestaurantIcon(String categoria) {
    return restaurantIcons[categoria] ?? 'assets/iconos/restaurantes.svg';
  }
}
